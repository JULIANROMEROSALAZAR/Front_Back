...
export const ROUTES: RouteInfo[] = [
    ...
    { path: 'dashboard', title: 'Noticias', menuType: MenuType.LEFT, icon: 'material-icons' },
    ...
    { path: 'pages/user', title: 'Mi Perfil', menuType: MenuType.LEFT, icon:'material-icons' },
    ...
    { path: 'forms/regular', title: 'Crear proyecto', menuType: MenuType.LEFT, icon:'pe-7s-note2' },
    { path: 'forms/extended', title: 'Modificar proyecto', menuType: MenuType.LEFT, icon:'pe-7s-note2' },
    ...
    { path: 'widgets', title: 'Avances', menuType: MenuType.LEFT, icon:'material-icons' },

    { path: 'charts', title: 'Reportes', menuType: MenuType.LEFT, icon:'material-icons' },
